...
public sealed class RepoScanPipeline : IRepoScanPipeline
{
    ...
    private static readonly HashSet<string> IgnoredDirectories = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "__pycache__",
        "coverage",
        // Migration directories: filenames indexed separately, content excluded to avoid SQL noise.
        "Migrations",
        "migrations",
    };
    ...
    // File name suffixes that always indicate machine-generated content.
    ...
    // First-line markers (checked in first 300 chars) that indicate auto-generated files.
    private static readonly string[] AutoGeneratedMarkers =
    [
        "// <auto-generated",
        "// <Auto-generated",
    ...
    private static bool ShouldIgnore(string relativePath, string absolutePath)
    {
        ...
        // Reject known generated file name suffixes (protobuf, Roslyn generators, WinForms designer).
    ...
    {
        // Probe only the first 300 characters — cheap and sufficient for header markers.
        var probe = content.Length > 300
            ? content.AsSpan(0, 300)
            : content.AsSpan();
        foreach (var marker in AutoGeneratedMarkers)
        {
            if (probe.IndexOf(marker.AsSpan(), StringComparison.OrdinalIgnoreCase) >= 0)
            {
                return true;
            }
        }
